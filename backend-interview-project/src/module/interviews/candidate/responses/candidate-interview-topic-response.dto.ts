...
/*
 * Response DTO cho Interview Topic ở phía Candidate.
 * Candidate dùng dữ liệu này để hiển thị danh sách focus topics.
 */
export class CandidateInterviewTopicResponseDto {
